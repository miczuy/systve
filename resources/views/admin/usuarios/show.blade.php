        ...
        <div class="w-full max-w-3xl bg-white rounded-[1.5rem] shadow-2xl overflow-hidden transform transition-all duration-300 hover:shadow-3xl group">
            ...
            <div class="relative bg-gradient-to-r from-cyan-600 to-blue-700 px-10 pt-8 pb-12 overflow-hidden">
                ...
                <div class="relative flex flex-col items-center space-y-4 text-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white tracking-tight font-playfair">Detalles del Usuario</h1>
                        <p class="mt-2 text-blue-100/90 font-light">Información completa del registro</p>
                    </div>
                </div>
            </div>
            ...
            <div class="px-10 py-8 space-y-6">
                ...
                <div class="space-y-6">
                        ...
                        <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="px-4 py-3 bg-white rounded-lg ring-1 ring-slate-200/60 shadow-sm">
                                    <p class="font-medium text-slate-800">{{ $usuario->name }}</p>
                                </div>
                            </div>
                            ...
                            <div class="space-y-1">
                                ...
                                <div class="px-4 py-3 bg-white rounded-lg ring-1 ring-slate-200/60 shadow-sm">
                                    <p class="font-medium text-slate-800">{{ $usuario->email }}</p>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="flex justify-center mt-8">
                        <a href="{{ url('admin/usuarios') }}" class="px-8 py-3 bg-gradient-to-br from-slate-500 to-slate-600 text-white/95 rounded-xl hover:shadow-lg transition-all duration-200 flex items-center space-x-2 group">
