        ...
        <div class="w-full max-w-3xl bg-white rounded-[1.5rem] shadow-2xl overflow-hidden transform transition-all duration-300 hover:shadow-3xl group">
            ...
            <div class="relative bg-gradient-to-r from-cyan-600 to-blue-700 px-10 pt-8 pb-12 overflow-hidden">
                ...
                <div class="relative flex flex-col items-center space-y-4 text-center">
                    ...
                    <div>
                        <h1 class="text-3xl font-bold text-white tracking-tight font-playfair">Editar Usuario</h1>
                        <p class="mt-2 text-blue-100/90 font-light">Actualización de credenciales de acceso</p>
                    </div>
                </div>
            </div>

            <form action="{{ url('admin/usuarios', $usuario->id) }}" method="POST" class="px-10 py-8 space-y-6">
                @csrf
                @method('PUT')
                ...
                <div class="flex justify-end space-x-3 mt-8">
                    <a href="{{ url('admin/usuarios') }}" class="px-6 py-3.5 border-2 border-slate-200 text-slate-600 rounded-xl hover:bg-slate-50/50 transition-all duration-200 flex items-center space-x-2 group">
                    ...
                    <button type="submit" class="px-8 py-3.5 bg-gradient-to-br from-cyan-600 to-blue-600 text-white/95 rounded-xl hover:shadow-lg transition-all duration-200 flex items-center space-x-2 group">
                        ...
                        <span class="font-medium">Actualizar Usuario</span>
                    </button>
                </div>
            </form>
        </div>
