...
@section('content')
    <div class="min-h-screen bg-gradient-to-br from-gray-50 via-indigo-50 to-purple-50 flex items-center justify-center p-4">
        <div class="w-full max-w-4xl bg-white rounded-[2rem] shadow-2xl overflow-hidden transform transition-all duration-300 hover:shadow-3xl">
            ...
            <form action="{{ url('/admin/configuraciones/create') }}" method="POST" class="px-10 py-8 space-y-10" enctype="multipart/form-data">
                @csrf
                        ...
                        <fieldset class="space-y-4">
                            ...
                            <div class="relative group">
                                ...
                                <label for="file" class="flex flex-col items-center justify-center w-full h-36 border-2 border-dashed border-indigo-200 rounded-xl cursor-pointer bg-gray-50 hover:bg-indigo-50/50 transition-all duration-200">
                                    ...
                                    <input id="file" type="file" name="logo" class="hidden" accept="image/*" required/>
                                </label>
                                @error('logo')
                            ...
                            <div class="grid grid-cols-1 md:grid-cols-6 gap-6">
                                ...
                                <div class="space-y-1 md:col-span-6">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input class="w-full pl-10 px-5 py-3.5 border-0 bg-gray-50/70 rounded-xl ring-2 ring-gray-200/60 focus:ring-4 focus:ring-indigo-400/30 focus:bg-white placeholder-gray-400/60 transition-all duration-200 shadow-sm" type="text" name="nombre" value="{{ old('nombre') }}" placeholder="Ej: Hospital San Rafael" required>
                                        @error('nombre')
                                ...
                                <div class="space-y-1 md:col-span-3">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input class="w-full pl-10 px-5 py-3.5 border-0 bg-gray-50/70 rounded-xl ring-2 ring-gray-200/60 focus:ring-4 focus:ring-indigo-400/30 focus:bg-white placeholder-gray-400/60 transition-all duration-200 shadow-sm" type="text" name="telefono" value="{{ old('telefono') }}" placeholder="Ej: +593 99 123 4567" required>
                                        @error('telefono')
                                        <div class="absolute right-4 top-1/2 -translate-y-1/2 flex items-center space-x-2">
                                            <svg class="w-5 h-5 text-red-500 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
                                ...
                                <div class="space-y-1 md:col-span-3">
                                    ...
                                    <div class="relative group">
                                        ...
                                        <input class="w-full pl-10 px-5 py-3.5 border-0 bg-gray-50/70 rounded-xl ring-2 ring-gray-200/60 focus:ring-4 focus:ring-indigo-400/30 focus:bg-white placeholder-gray-400/60 transition-all duration-200 shadow-sm" type="email" name="correo" value="{{ old('correo') }}" placeholder="Ej: contacto@hospital.com" required>
                                        @error('correo')
                                        <div class="absolute right-4 top-1/2 -translate-y-1/2 flex items-center space-x-2">
                                            <svg class="w-5 h-5 text-red-500 animate-pulse" fill="currentColor" viewBox="0 0 20 20">
                                                <path fill-rule="evenodd" d="M18 10a8 8 0 11-16 0 8 8 0 0116 0zm-7 4a1 1 0 11-2 0 1 1 0 012 0zm-1-9a1 1 0 00-1 1v4a1 1 0 102 0V6a1 1 0 00-1-1z" clip-rule="evenodd"/>
