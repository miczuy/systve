                                ...
                                <tr class="hover:bg-blue-50/30 transition-colors duration-200 group">
                                    ...
                                    <td class="px-6 py-4 whitespace-nowrap text-right text-sm">
                                        <div class="flex items-center justify-end space-x-3 opacity-100">
                                            ...
                                            <!-- Delete -->
                                            <a href="{{ url('admin/pacientes/'.$paciente->id.'/confirm-delete') }}" class="p-2 rounded-lg bg-white shadow-sm hover:shadow-md border border-gray-200 hover:border-red-200 transition-all">
